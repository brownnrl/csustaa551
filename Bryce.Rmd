...
*grade*
Holding all else constant, a one level increase in grade will result in a increase in price of 26.67 percent.

*view*
Holding all else constant, a one level increase in view will result in an increase in price of 12.23 percent.

*yr_built*
Holding all else constant, a one year increase in the year the house was built will result in a -.45% decrease in housing price.
